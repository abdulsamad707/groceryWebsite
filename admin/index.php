    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <?php
   $keyApi="";
  $urlinventorycurrent = "http://localhost/groceryWebsite/api/inventory.php?key=avdfheuw23&invtype=current";
       $curl = curl_init();
 curl_setopt($curl, CURLOPT_URL, $urlinventorycurrent);
curl_setopt($curl,CURLOPT_POST,false);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
curl_setopt($curl, CURLOPT_HEADER, false);
 $dataUrlinventorycurrent= curl_exec($curl);
 curl_close($curl);
$dataUrlinventorycurrent=json_decode($dataUrlinventorycurrent,true);
$totalRecord=$dataUrlinventorycurrent['totalRecord'];
if($totalRecord>0){
$dataUrlinventorycurrentearning=$dataUrlinventorycurrent['data'][0]["Earning"];
}else{
  $dataUrlinventorycurrentearning=0;
}
$urlinventoryprevious = "http://localhost/groceryWebsite/api/inventory.php?key=avdfheuw23&invtype=previous";
$curl = curl_init();
curl_setopt($curl, CURLOPT_URL, $urlinventoryprevious);
curl_setopt($curl,CURLOPT_POST,false);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
curl_setopt($curl, CURLOPT_HEADER, false);
$dataUrlinventoryprevious= curl_exec($curl);
curl_close($curl);
$dataUrlinventoryprevious=json_decode($dataUrlinventoryprevious,true);
   $totalRecord=$dataUrlinventoryprevious['totalRecord'];
   if($totalRecord > 0){
 $dataUrlinventorypreviousearning=$dataUrlinventoryprevious['data'][0]["Earning"];
   }else{
    $dataUrlinventorypreviousearning=0;
   }
 $diff=$dataUrlinventorycurrentearning-$dataUrlinventorypreviousearning;
  
 
 $prec=round(($diff/$dataUrlinventorycurrentearning)*100);
 if($diff<0){
       $perText="decrease";
    }else{
      $perText="increase";
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?= $dataUrlinventorycurrentearning;?> PKR</h6>
...
inventoryEarningDaily.push(value.Earning);
            ...
            <div class="col-12">
              ...
              <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                ...
                <?php
   $keyApi="";
  $urlinventorydaily = "http://localhost/groceryWebsite/api/inventory.php?key=avdfheuw23&invtype=daily";
       
 
$curl = curl_init();
 
curl_setopt($curl, CURLOPT_URL, $urlinventorydaily);
curl_setopt($curl,CURLOPT_POST,false);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
curl_setopt($curl, CURLOPT_HEADER, false);
 
$dataUrlinventorydaily= curl_exec($curl);
 
curl_close($curl);

   $dataUrlinventorydaily=json_decode($dataUrlinventorydaily,true);
      ...
      ?>
                ...
                <?php
            $keyApi="";
        $urlinventorymonthly = "http://localhost/groceryWebsite/api/inventory.php?key=avdfheuw23&invtype=monthly";
       
 
$curl = curl_init();
 
curl_setopt($curl, CURLOPT_URL, $urlinventorymonthly);
curl_setopt($curl,CURLOPT_POST,false);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
curl_setopt($curl, CURLOPT_HEADER, false);
 
$dataUrlinventorymontly= curl_exec($curl);
 
curl_close($curl);

   $dataUrlinventorymontly=json_decode($dataUrlinventorymontly,true);
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">Top 5  Sell Product  </h5>
